...
macro Tweak_31_KickedSpritesHitBlocksOffscreen()
    org $0199A6
        bra $0F
endmacro
...
macro Tweak_59_CourseClearCoins()
    org $05CD51|!bank
    db $2E,$3C
...
macro Tweak_67_NoMoreFireballsWhileSpinjumping()
    org $00D093                ;don't shoot fireballs while spinjumping
    db $80
endmacro

; Kicked Sprites Hit Blocks Offscreen
%Tweak_31_KickedSpritesHitBlocksOffscreen()

; Remove "MARIO START!"
%Tweak_54_RemoveMARIOSTART()

; Course Clear Coins
%Tweak_59_CourseClearCoins()

; No More Fireballs While Spinjumping
%Tweak_67_NoMoreFireballsWhileSpinjumping()
